...
| spa                     | [spaApplication](../resources/spaapplication.md)                                         | Specifies settings for a single-page application. `spa` type redirect URIs notify the server to enable CORS and use the authorization code flow.                  |
